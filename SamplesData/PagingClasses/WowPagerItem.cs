...
{
  public class WowPagerItem
  {
    #region Constructors
    public WowPagerItem(int pageCount, int pageIndex, string tooltip)
    {
      Init();
    ...
    public WowPagerItem(string text, string arg, bool disabled, string tooltip)
    {
      Init();
